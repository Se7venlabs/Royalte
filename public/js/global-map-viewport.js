...
(function (root) {
   ...
   */
  var DESKTOP_ANCHORS = {
    'Canada':         { l: 18.0, t: 22.0, flag: '🇨🇦', p: ['apple','spotify','deezer','tidal'], d: 'Jan 2024' },
    'United States':  { l: 18.0, t: 35.0, flag: '🇺🇸', p: ['apple','spotify','deezer','tidal'], d: 'Jan 2024' },
    'Mexico':         { l: 17.0, t: 50.0, flag: '🇲🇽', p: ['apple','spotify'],                  d: 'Mar 2024' },
    'Brazil':         { l: 33.0, t: 72.0, flag: '🇧🇷', p: ['apple','spotify','deezer'],          d: 'Jan 2024' },
    'Peru':           { l: 35.0, t: 85.0, flag: '🇵🇪', p: ['apple','spotify'],                  d: 'Mar 2024' },
    'United Kingdom': { l: 46.0, t: 30.0, flag: '🇬🇧', p: ['apple','spotify','deezer','tidal'], d: 'Jan 2024' },
    'France':         { l: 47.0, t: 35.0, flag: '🇫🇷', p: ['apple','spotify','deezer','tidal'], d: 'Jan 2024' },
    'Germany':        { l: 48.0, t: 32.0, flag: '🇩🇪', p: ['apple','spotify','deezer','tidal'], d: 'Jan 2024' },
    'Spain':          { l: 45.0, t: 40.0, flag: '🇪🇸', p: ['apple','spotify','deezer'],          d: 'Jan 2024' },
    'Italy':          { l: 51.0, t: 36.0, flag: '🇮🇹', p: ['apple','spotify','deezer'],          d: 'Jan 2024' },
    'Sweden':         { l: 54.0, t: 17.0, flag: '🇸🇪', p: ['apple','spotify','deezer','tidal'], d: 'Jan 2024' },
    'Poland':         { l: 52.0, t: 32.0, flag: '🇵🇱', p: ['apple','spotify','deezer'],          d: 'Mar 2024' },
    'South Africa':   { l: 53.0, t: 85.0, flag: '🇿🇦', p: ['apple','spotify','deezer'],          d: 'Feb 2024' },
    'Egypt':          { l: 54.0, t: 49.0, flag: '🇪🇬', p: ['apple','spotify'],                  d: 'Mar 2024' },
    'Norway':         { l: 50.0, t: 25.0, flag: '🇳🇴', p: ['apple','spotify','deezer','tidal'], d: 'Jan 2024' },
    'Türkiye':        { l: 57.0, t: 37.0, flag: '🇹🇷', p: ['apple','spotify'],                  d: 'Mar 2024' },
    ...
    'India':          { l: 68.0, t: 52.0, flag: '🇮🇳', p: ['apple','spotify'],                  d: 'Feb 2024' },
    'China':          { l: 74.0, t: 40.0, flag: '🇨🇳', p: ['apple'],                            d: 'Jan 2024' },
    'Japan':          { l: 85.0, t: 43.0, flag: '🇯🇵', p: ['apple','spotify','deezer','tidal'], d: 'Jan 2024' },
    'South Korea':    { l: 82.0, t: 42.0, flag: '🇰🇷', p: ['apple','spotify','deezer','tidal'], d: 'Jan 2024' },
    'Australia':      { l: 83.0, t: 81.0, flag: '🇦🇺', p: ['apple','spotify','deezer'],          d: 'Jan 2024' },
    'New Zealand':    { l: 87.0, t: 70.0, flag: '🇳🇿', p: ['apple','spotify'],                  d: 'Feb 2024' },
  };
