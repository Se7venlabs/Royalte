...
The canonical Mission Control Architecture text has not been provided in source form.
...
Populate only with the Board-approved architecture text when provided.
-->
