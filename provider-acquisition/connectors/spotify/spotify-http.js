...
// Returns what Spotify said; callers decide what it means.
...
/**
 * Perform an authenticated GET against the Spotify Web API.
 *
 * @returns {{
 *   ok:          boolean,
 *   status?:     number,
 ...
 * }}
 */
export async function spotifyGet(path, token, options = {}) {
  const {
