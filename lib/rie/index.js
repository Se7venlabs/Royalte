...
//     • assembleRecordingIntelligence receives canonicalForEnrichment
//       (Phase 3.7 addition — same pattern, documented here per Platform
//       Recovery Phase 1 governance/CANONICAL_SCHEMA_CIO_CIM_PLATFORM_CERTIFICATION.md)
...
//   design since Phase 5.2. This closes all 3 of the original certified
...
//   only assembleRecordingIntelligence (added later, Phase 3.7) remains.
...
export async function runRIE(evidence, options = {}) {
  ...
  try { recordingIntelligence = assembleRecordingIntelligence(canonicalForEnrichment); }
